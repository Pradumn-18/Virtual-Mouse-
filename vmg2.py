...
red_range = np.array([[33,80,40],[102,255,255]])
...
#Mouse Dampening Method
nLocOld=np.array([0,0] ) #use of numpy to make arrays
mouseLoc=np.array([0,0] )  #use of numpy to make arrays
Dampingfactor=2 #Value should be more than 1

pinchFlag=0	#0 means it is not a pinch operation


openx,openy,openw,openh=(0,0,0,0)
#mouseLoc=nLocOld+(targetLoc-nLocOld)/Dampingfactor     #to make mouse movement smoother
#more the value of damping factor,smoother the mouse movement will begin
